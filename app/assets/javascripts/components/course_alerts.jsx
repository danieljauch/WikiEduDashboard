...
const CourseAlerts = createReactClass({
  ...
  render() {
    ...
    if (userRoles.isNonstudent && course.published && hasNoStudents && !course.legacy) {
      ...
      alerts.push(<CourseAlert key="enroll" message={I18n.t(`${course.string_prefix}.published`)} buttonLink={url} actionMessage={url} />);
    }
